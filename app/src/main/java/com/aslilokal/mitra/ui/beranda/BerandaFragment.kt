...
import com.aslilokal.mitra.databinding.FragmentBerandaBinding
import com.aslilokal.mitra.databinding.ItemBerandaImageBinding
import com.aslilokal.mitra.model.local.ItemBerandaImage
...
class BerandaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.rlUtang.setOnClickListener {
            startActivity(Intent(activity, ListAllDebtorActivity::class.java))
        }
