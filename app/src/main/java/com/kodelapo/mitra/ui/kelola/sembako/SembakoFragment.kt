package com.kodelapo.mitra.ui.kelola.sembako
...
import com.kodelapo.mitra.databinding.FragmentSembakoBinding
...
import com.kodelapo.mitra.utils.Constants.Companion.QUERY_PAGE_SIZE
...
class SembakoFragment : Fragment() {
    ...
    private var _binding: FragmentSembakoBinding? = null
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvSembako.apply {
            adapter = productAdapter
            layoutManager = GridLayoutManager(binding.root.context, 2)
            addOnScrollListener(this@SembakoFragment.scrollListener)
        }
    }
